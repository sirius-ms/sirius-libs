    ...
    private FasterTreeComputationInstance(FragmentationPatternAnalysis analyzer, ProcessedInput input, FTree tree, ProcessedInput initialInput) {
        ...
        if (decomp==null) {
            ...
            if (decomp==null){
                ...
                LoggerFactory.getLogger(FasterTreeComputationInstance.class).warn("use initial processed inputs decomposition list for "+initialInput.getOriginalInput().getName()+" "+tree.getRoot().getFormula());
            }
