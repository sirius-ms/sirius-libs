...
//                candidate.addNodeProbabilityScore(1d); //probabilities should not be influenced at all
                ...
                if (cosine>1.01) throw new RuntimeException(String.format("Cosine score for %s is greater than 1: %d", libraryHit.getQueryExperiment().getName(), cosine));
...
//        return -lambda * (1d - Math.max(cosine, lowestCosine));
//    }
}
