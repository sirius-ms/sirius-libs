...
public class AuthService implements IOFunctions.IOConsumer<Request.Builder>, Closeable {
    ...
    public AuthService(@NotNull DefaultApi20 authAPI, @NotNull String clientID, @Nullable OkHttpClient client) {
    ...
    public AuthService(@NotNull DefaultApi20 authAPI, @NotNull String clientID, @Nullable String clientSecret, @Nullable String refreshToken, @Nullable OkHttpClient client) {
